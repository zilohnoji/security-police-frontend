...
export class PainelAdmin implements OnInit {
  ...
  protected profile = signal<PersonDetailsResponse | null>(null);

  protected models = signal([
    {
      label: "Dashboard",
      router: "/painel/admin",
  ...
  ngOnInit(): void {
    this._personService.MyProfile().pipe(
      tap((response: PersonDetailsResponse) => {
